...
## 1.3 Խնդրի դրվածք։ {#խնդրի-դրվածք .DIplom-etnaglux}
...
$$
>Z=
$\sum_{i = 1}^{n}\left( C_{i}*x_{i} - {C\ }_{i}^{'}*x_{i}^{'} \right) \rightarrow min$
...
Յուրաքանչյուր i ժամի համար ունենք երկու փոփոխական՝$x_{i}$ և $x_{i}^{'}$
հավասարումը կարելի է գրել՝
$$x_{i} + q_{i} = x_{i}^{'} + r_{i\ }
$$երբ $\ q_{i} \leq r_{i\ }$ Simplex աղյուսակը կլինի․

  ------------------------------------------------------------------------------------------------------------------------------
  Բազիս       $$x_{1}$$   $$x_{1}^{'}$$               **․․․**   $$x_{i}$$   $$x_{i}^{'}$$               $$\overrightarrow{b}$$
  ----------- ----------- --------------------------- --------- ----------- --------------------------- ------------------------
  $$x_{1}$$   **1**       **-1**                      **․․․**   **0**       **0**                       $$r_{1\ } - q_{1}$$

  **․․․**     **․․․**     **․․․**                     **․․․**   **․․․**     **․․․**                     **․․․**

  $x_{i}$     **0**       **0**                       **․․․**   **1**       **-1**                      $$r_{i\ } - q_{i}$$

              **0**       $$C_{1} - {C\ }_{1}^{'}$$   **․․․**   **0**       $$C_{i} - {C\ }_{i}^{'}$$   Z
  ------------------------------------------------------------------------------------------------------------------------------
...
երբ $q_{i} > r_{i\ }\ \ $Simplex աղյուսակը կլինի․
  ...
  Բազիս       $$x_{1}$$                   $$x_{1}^{'}$$   **․․․**   $$x_{i}$$           $$x_{i}^{'}$$   $$\overrightarrow{b}$$   
  ----------- --------------------------- --------------- --------- ------------------- --------------- ------------------------ --
  $$x_{1}$$   **-1**                      **1**           **․․․**   **0**               **0**           $$q_{1} - r_{1\ }$$      

  **․․․**     **․․․**                     **․․․**         **․․․**   **․․․**             **․․․**         **․․․**                  

  $x_{i}$     **0**                       **0**           **․․․**   **-1**              **1**           $$q_{i}{- r}_{i\ }$$     

              $${C\ }_{1}^{'} - C_{1}$$   **0**           **․․․**   ${C\ }_{i}^{'} -$   **0**           Z                        
                                                                    $C_{i}$                                                      
  ---------------------------------------------------------------------------------------------------------------------------------
...
$$\left\{ \ \ \ \begin{array}{r}
IF\ q_{i} < r_{i\ }:\begin{array}{r}
x_{i} = \ 
\end{array}r_{i\ } - q_{i}\ \ \ ,\ x_{i}^{'} = 0 \\
{IF\ q_{i} > r_{i\ }:\ x}_{i}^{'} = q_{i}{- r}_{i\ }\ \ ,x_{i} = 0\  \\
{IF\ q_{i} = r_{i\ }:\ x}_{i}^{'} = \ x_{i}\ 
\end{array} \right.\ $$
...
-   $\eta_{c}h\  - \ լիցքավորման\ \ արդյունավետություն$

-   $\eta_{d}is\  - \ լիցքաթափման\ \ արդյունավետություն$

-   $B_{m}ax\  - \ մարտկոցի\ \ առավելագույն\ \ տարողությունը$
...
$\mathbf{B}_{\mathbf{i}}$​-ով, ներկայացնում է մարտկոցի լիցքավորման
...
հոսքը՝$\mathbf{C}_{\mathbf{i}}^{\mathbf{ch}}$​, ցույց է տալիս այն
...
$\mathbf{D}_{\mathbf{i}}\mathbf{}$ փոփոխականը ներկայացնում է մարտկոցից
...
$\mathbf{\eta}_{\mathbf{ch}}$​, ցույց է տալիս թե մուտք եղած էներգիայի որ
...
արդյունավետությունը՝ $\mathbf{\eta}_{\mathbf{dis}}$, ցույց է տալիս որ
...
է$\ \mathbf{B}_{\mathbf{\max}}$, սահմանում է մարտկոցի ֆիզիկական
...
Վերջապես, մարտկոցի սկզբնական վիճակը՝ $\mathbf{B}_{\mathbf{0}}$​,
...
Z=
$\sum_{i = 1}^{n}\left( C_{i}*x_{i} - {C\ }_{i}^{'}*x_{i}^{'} + d*D_{i} \right) \rightarrow min$
,\
